---
title: "Asado Libre Buffet de Carnes Argentinas"
format:
  html:
    toc: false
params:
  id: "ChIJu1IehXejpBIReyol-Gsmu3Y"
---
...
document.addEventListener('DOMContentLoaded', async () => {
  const centerId = "ChIJu1IehXejpBIReyol-Gsmu3Y"; // this is the place_id
  ...
  const CENTERS_URL = encodeURI(`${BASE}/data/test centers_with_google_maps_and_website_information.json`);
            ...
            ${
              center.editorial
                ...
                : (center.description
                    ...
                    : `<p>Welcome to the page for ${center.name}${center.city ? ' in ' + center.city : ''}.</p>`
                  )
            }
